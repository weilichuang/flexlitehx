...
interface IDllConfig
{
	...
	*/
    function parseConfig(data : Dynamic, folder : String) : Void;
    /**
	* 根据组名获取组加载项列表
	* @param name 组名
	*/
    function getGroupByName(name : String) : Array<DllItem>;
    /**
	* 创建自定义的加载资源组
	...
	*/
    function createGroup(name : String, keys : Array<Dynamic>, overrideOld : Bool = false) : Bool;
    /**
	* 获取加载项类型。
