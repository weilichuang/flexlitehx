...
class CollectionEvent extends Event
{
	...
	* 集合类数据发生改变 
	*/
    public static inline var COLLECTION_CHANGE : String = "collectionChange";
    
    public function new(type : String, bubbles : Bool = false,
            cancelable : Bool = false,
            kind : String = null, location : Int = -1,
            oldLocation : Int = -1, items : Array<Dynamic> = null, oldItems : Array<Dynamic> = null)
    {
        ...
        this.oldItems = (oldItems != null) ? oldItems : [];
    }
    /**
	...
	*/
    public var oldItems : Array<Dynamic>;
    /**
