...
class TreeEvent extends Event
{
	...
	*/
    public static inline var ITEM_OPENING : String = "itemOpening";
    
    public function new(type : String, bubbles : Bool = false, cancelable : Bool = true,
            itemIndex : Int = -1, item : Dynamic = null, itemRenderer : ITreeItemRenderer = null)
    {
